  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto">
      ...
      <div className="rounded-lg border bg-violet-50/40 p-4 flex items-start gap-3 text-sm">
        ...
        <p className="text-muted-foreground">
          <strong className="text-foreground">Nota legale:</strong> il classificatore di ComplyAI fornisce un orientamento basato sulle risposte fornite. La valutazione finale, in particolare per sistemi ad alto rischio, richiede una revisione legale specialistica.
        </p>
      </div>
    </div>
  );
